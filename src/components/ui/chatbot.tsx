    ...
    <div className="chatbot-container">
      ...
      >
        <div className="relative flex w-full items-center justify-center p-4">
          <AnimatePresence>
            <div key="title-container" className="tracking-tightest flex select-none flex-col py-2 text-center text-3xl font-extrabold leading-none md:flex-col md:text-8xl lg:flex-row"></div>
            {hovered && (
              <motion.div
                key="canvas-effect"
                initial={{ opacity: 1 }}
          ...
          <div className="z-20 w-full">
            ...
            <div className="relative mt-2 w-full">
              <form>
                <div className="">
                  <Input
                    ...
                    placeholder="سوال خود را از مشاور کسب و کار بپرسید"
                  />
                </div>
              </form>
              ...
              <Button
                variant="default"
                size="icon"
                className="absolute right-1.5 top-1.5 h-7 rounded-sm right-button"
              >
                <DIcons.Plus className="h-5 w-5" />
                <span className="sr-only">چت جدید</span>
              </Button>
              ...
              <Button
                ...
                variant="default"
                size="icon"
                className="absolute left-1.5 top-1.5 h-7 rounded-sm left-button"
              >
